...
public class W3c_Xml {
 ...
 public static void readXML() {
  try {
      ...
      Document document = builder.parse(new File("E:/AndroidManifest.xml"));
      ...
      NodeList list = rootElement.getElementsByTagName("manifest");
 ...
 public static void updateXML()
 {
     try {
        ...
        writeXML(document,"E:/AndroidManifest.xml");
